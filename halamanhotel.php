          ...
          <div class="row">
            ...
            <div class="col-xs-10 text-right menu-1">
              <ul>
                ...
                <li><a href="sudahlogin.php">Logout</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12 animate-box">
            <div class="owl-carousel owl-carousel2">
              ...
              <div class="item">
                ...
                <div class="desc text-center">
                  <span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
                  <h3><a href="rooms-suites.html">Deluxe Double Room</a></h3>
                  <p class="price">
                    <span class="currency">$</span>
              ...
              <div class="item">
                ...
                <div class="desc text-center">
                  <span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
                  <h3><a href="rooms-suites.html">Deluxe Family Room</a></h3>
                  <p class="price">
      ...
      <div class="container">
        <div class="row row-pb-md">
          <div class="col-md-3 colorlib-widget">
            <h4>AFW Hotel</h4>
            <p> 
A hotel that suits you who want to rest or stay, we provide facilities, with the comfort you need, your comfort is perfection for us..</p>
          </div>
          <div class="col-md-3 colorlib-widget">
            <h4>Quick Links</h4>
            <p>
